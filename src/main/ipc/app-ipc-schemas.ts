import { z } from 'zod'
import {
  QWICKS_APPROVAL_TEMPLATE,
  QWICKS_ATTACHMENT_CONTENT_TEMPLATE,
  QWICKS_ATTACHMENT_DIAGNOSTICS_TEMPLATE,
  QWICKS_ATTACHMENTS_TEMPLATE,
  QWICKS_ATTACHMENT_TEMPLATE,
  QWICKS_HEALTH_TEMPLATE,
  QWICKS_MEMORY_DIAGNOSTICS_TEMPLATE,
  QWICKS_MEMORY_RECORD_TEMPLATE,
  QWICKS_MEMORY_TEMPLATE,
  QWICKS_RUNTIME_INFO_TEMPLATE,
  QWICKS_RUNTIME_TOOLS_TEMPLATE,
  QWICKS_SESSION_RESUME_TEMPLATE,
  QWICKS_SKILLS_TEMPLATE,
  QWICKS_THREADS_TEMPLATE,
  QWICKS_THREAD_COMPACT_TEMPLATE,
  QWICKS_THREAD_FORK_TEMPLATE,
  QWICKS_THREAD_GOAL_TEMPLATE,
  QWICKS_THREAD_REVIEW_TEMPLATE,
  QWICKS_THREAD_REWIND_TEMPLATE,
  QWICKS_THREAD_TODOS_TEMPLATE,
  QWICKS_THREAD_INTERRUPT_TEMPLATE,
  QWICKS_THREAD_STEER_TEMPLATE,
  QWICKS_THREAD_TURNS_TEMPLATE,
  QWICKS_THREAD_TEMPLATE,
  QWICKS_USER_INPUT_TEMPLATE,
  QWICKS_USAGE_TEMPLATE,
  QWICKS_DEBUG_LLM_ROUNDS_TEMPLATE
...
import { DESKTOP_COMMANDS } from '../../shared/qwicks-gui-api'
...
const ENDPOINTS: readonly EndpointTemplate[] = [
  compileEndpoint(QWICKS_HEALTH_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_RUNTIME_INFO_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_RUNTIME_TOOLS_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_SKILLS_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_ATTACHMENTS_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_ATTACHMENT_DIAGNOSTICS_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_ATTACHMENT_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_ATTACHMENT_CONTENT_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_MEMORY_TEMPLATE, ['GET', 'POST']),
  compileEndpoint(QWICKS_MEMORY_DIAGNOSTICS_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_MEMORY_RECORD_TEMPLATE, ['PATCH', 'DELETE']),
  compileEndpoint(QWICKS_THREADS_TEMPLATE, ['GET', 'POST']),
  compileEndpoint(QWICKS_THREAD_TEMPLATE, ['GET', 'PATCH', 'DELETE']),
  compileEndpoint(QWICKS_THREAD_FORK_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_GOAL_TEMPLATE, ['GET', 'POST', 'DELETE']),
  compileEndpoint(QWICKS_THREAD_TODOS_TEMPLATE, ['GET', 'POST', 'DELETE']),
  compileEndpoint(QWICKS_THREAD_COMPACT_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_REVIEW_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_REWIND_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_TURNS_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_STEER_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_THREAD_INTERRUPT_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_APPROVAL_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_USER_INPUT_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_SESSION_RESUME_TEMPLATE, ['POST']),
  compileEndpoint(QWICKS_USAGE_TEMPLATE, ['GET']),
  compileEndpoint(QWICKS_DEBUG_LLM_ROUNDS_TEMPLATE, ['GET'])
]
...
const qwicksStorageBackendSchema = z.enum(['hybrid', 'file'])
const qwicksCompactionSummaryModeSchema = z.enum(['heuristic', 'model'])
...
const qwicksRuntimePatchSchema = z.object({
  ...
  storage: z.object({
    backend: qwicksStorageBackendSchema.optional(),
  ...
  contextCompaction: z.object({
    ...
    summaryMode: qwicksCompactionSummaryModeSchema.optional(),
...
const settingsPatchObjectSchema = z.object({
  ...
  agents: z.object({
    qwicks: qwicksRuntimePatchSchema.optional()
  }).strict().optional(),
  workspaceRoot: defaultPathSchema,
