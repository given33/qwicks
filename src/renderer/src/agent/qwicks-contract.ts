...
export type CoreRuntimeCapabilityManifestJson = {
  ...
  /** Optional so the GUI keeps working against older QWicks builds without the capability. */
 ...
 * `create_plan` tool result. Mirrors the QWicks output contract
 ...
 * reserved plan id, workspace root, and relative path the QWicks
...
/**
 * Native QWicks plan tool name. Re-exported alongside the shared
