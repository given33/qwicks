 ...
 */
export async function dispatchQWicksRuntimeEvents(
  ...
  for (const event of events) {
    ...
    flushDeltas()
    await dispatchQWicksRuntimeEvent(event, sink, handleApprovalRequest)
  }
  flushDeltas()
}

export async function dispatchQWicksRuntimeEvent(
  event: CoreRuntimeEventJson,
  sink: ThreadEventSink,
  handleApprovalRequest: (event: CoreRuntimeEventJson, sink: ThreadEventSink) => Promise<void>
): Promise<void> {
