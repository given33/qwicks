...
import { chatBlockFromItem, dispatchQWicksRuntimeEvent, mergeChatBlocks } from './qwicks-mapper'
import type { CoreRuntimeEventJson, CoreTurnItemJson } from './qwicks-contract'
...
describe('create_plan tool mapping', () => {
  it('surfaces turn failure messages from QWicks lifecycle events', async () => {
  ...
  it('surfaces create_plan tool events through the event sink', () => {
    ...
    void dispatchQWicksRuntimeEvent(event, sink, async () => undefined)
...
describe('QWicks extension metadata mapping', () => {
