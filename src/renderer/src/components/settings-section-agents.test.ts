...
const labels: Record<string, string> = {
  ...
  qwicksProvider: 'Provider',
  qwicksProviderDesc: 'Provider description',
  qwicksProviderSelectDesc: 'Provider select description',
  ...
  qwicksApiKey: 'QWicks API key',
  qwicksApiKeyDesc: 'QWicks API key description',
  qwicksApiKeyPlaceholder: 'Inherit API key',
  qwicksApiKeyInherited: 'Inherited API key',
  qwicksApiKeyMissing: 'Missing API key',
  qwicksApiKeyOverride: 'Override API key',
  qwicksBaseUrl: 'QWicks base URL',
  qwicksBaseUrlDesc: 'QWicks base URL description',
  qwicksBaseUrlPlaceholder: 'Inherit base URL',
  qwicksBaseUrlOfficial: 'Official base URL',
  qwicksBaseUrlInherited: 'Inherited base URL',
  qwicksBaseUrlOverride: 'Override base URL',
  qwicksAssistantAdvanced: 'Assistant advanced settings',
  qwicksAssistantAdvancedDesc: 'Assistant advanced settings description',
  autoStart: 'Auto start',
  autoStartDesc: 'Auto start description',
  port: 'Port',
  portDesc: 'Port description',
  qwicksBinary: 'QWicks binary',
  qwicksBinaryDesc: 'QWicks binary description',
  qwicksBinaryPlaceholder: 'Bundled QWicks',
  qwicksDataDir: 'Data dir',
  qwicksDataDirDesc: 'Data dir description',
  qwicksModel: 'Model',
  qwicksModelDesc: 'Model description',
  qwicksTokenEconomy: 'Token-saving mode',
  qwicksTokenEconomyDesc: 'Token-saving mode description',
  qwicksTokenEconomySavings: 'Saved {{tokens}} tokens',
  qwicksTokenEconomySavingsLoading: 'Loading savings',
  qwicksTokenEconomySavingsEmpty: 'Savings empty',
  qwicksTokenEconomyAdvanced: 'Token-saving advanced settings',
  qwicksTokenEconomyAdvancedDesc: 'Token-saving advanced settings description',
  qwicksTokenEconomyOptions: 'Token-saving options',
  qwicksTokenEconomyOptionsDesc: 'Token-saving options description',
  qwicksCompressToolDescriptions: 'Compress tool descriptions',
  qwicksCompressToolResults: 'Compress tool results',
  qwicksConciseResponses: 'Concise responses',
  qwicksHistoryHygiene: 'History guard',
  qwicksHistoryHygieneDesc: 'History guard description',
  qwicksHistoryMaxResultLines: 'Max result lines',
  qwicksHistoryMaxResultBytes: 'Max result bytes',
  qwicksHistoryMaxResultTokens: 'Max result tokens',
  qwicksHistoryMaxArgumentBytes: 'Max argument bytes',
  qwicksHistoryMaxArgumentTokens: 'Max argument tokens',
  qwicksHistoryMaxArrayItems: 'Max array items',
  runtimeToken: 'Runtime token',
  runtimeTokenDesc: 'Runtime token description',
  showSecret: 'Show',
  hideSecret: 'Hide',
  qwicksInsecure: 'Insecure',
  qwicksInsecureDesc: 'Insecure description',
  qwicksInsecureForcedDesc: 'Insecure forced',
  qwicksAdvanced: 'Advanced runtime settings',
  qwicksAdvancedDetails: 'Storage, model context, and tool guards',
  qwicksAdvancedDetailsDesc: 'Per-model context policy comes from models.profiles',
  qwicksStorageBackend: 'Storage backend',
  qwicksStorageBackendDesc: 'Storage backend description',
  qwicksStorageHybrid: 'Hybrid storage',
  qwicksStorageFile: 'Pure JSONL file storage',
  qwicksStorageSqlitePath: 'SQLite path',
  qwicksStorageSqlitePathDesc: 'SQLite path description',
  qwicksStorageSqlitePathPlaceholder: 'Automatic SQLite path',
  qwicksModelContextProfile: 'Current model context policy',
  qwicksModelContextProfileDesc: 'Current model context policy description',
  qwicksModelContextModel: 'Matched model',
  qwicksModelContextWindow: 'Context window',
  qwicksModelContextSoft: 'Model soft threshold',
  qwicksModelContextHard: 'Model hard threshold',
  qwicksModelContextSourceBuiltIn: 'Built-in model config',
  qwicksModelContextSourceFallback: 'Fallback model config',
  qwicksCompactionThresholds: 'Fallback compaction thresholds',
  qwicksCompactionThresholdsDesc: 'Fallback compaction thresholds description',
  qwicksCompactionSoftThreshold: 'Fallback soft threshold',
  qwicksCompactionHardThreshold: 'Fallback hard threshold',
  qwicksCompactionSummary: 'Compaction summary',
  qwicksCompactionSummaryDesc: 'Compaction summary description',
  qwicksCompactionSummaryMode: 'Summary mode',
  qwicksCompactionSummaryHeuristic: 'Heuristic summary',
  qwicksCompactionSummaryModel: 'Model summary',
  qwicksCompactionSummaryTimeout: 'Summary timeout',
  qwicksCompactionSummaryMaxTokens: 'Summary max tokens',
  qwicksCompactionSummaryInputBytes: 'Summary input bytes',
  qwicksToolStorm: 'Tool storm',
  qwicksToolStormDesc: 'Tool storm description',
  qwicksToolStormLimits: 'Tool storm limits',
  qwicksToolStormLimitsDesc: 'Tool storm limits description',
  qwicksToolStormWindowSize: 'Tool storm window',
  qwicksToolStormThreshold: 'Tool storm threshold',
  qwicksToolArgumentRepair: 'Tool argument repair',
  qwicksToolArgumentRepairDesc: 'Tool argument repair description',
  qwicksDiagnostics: 'QWicks diagnostics',
  qwicksDiagnosticsAdvanced: 'Detailed diagnostics',
  qwicksDiagnosticsAdvancedDesc: 'Detailed diagnostics description',
  qwicksRuntimeCapabilities: 'Runtime capabilities',
  qwicksRuntimeCapabilitiesDesc: 'Runtime capabilities description',
  qwicksRuntimeModel: 'Runtime model',
  qwicksRuntimePid: 'Runtime PID',
  qwicksDiagnosticsRefresh: 'Refresh diagnostics',
  qwicksToolDiagnostics: 'Tool diagnostics',
  qwicksToolDiagnosticsDesc: 'Tool diagnostics description',
  qwicksDiagnosticsProviders: 'Providers',
  qwicksDiagnosticsMcpServers: 'MCP servers',
  qwicksDiagnosticsSkills: 'Discovered Skills',
  qwicksDiagnosticsAttachments: 'Attachments',
  qwicksMemoryRecords: 'Memory records',
  qwicksMemoryRecordsDesc: 'Memory records description',
  qwicksMemoryEmpty: 'No memories',
  qwicksMemoryDisable: 'Disable memory',
  qwicksMemoryDelete: 'Delete memory',
  qwicksMemoryDisabled: 'Disabled',
  skill: 'Skill',
...
function baseCtx(): Record<string, unknown> {
  ...
  return {
    ...
    openPlugins: noop,
    mcpConfigPath: '/tmp/project/.qwicks/mcp.json',
    ...
    refreshQWicksDiagnostics: asyncNoop,
...
describe('AgentsSettingsSection QWicks diagnostics smoke', () => {
  it('builds a single patch when adding and selecting a model provider', () => {
    ...
    const patch = modelProvidersSettingsPatch({
      ...
      qwicks: { providerId: customProvider.id }
    })

    expect(patch.provider?.providers).toEqual([...provider.providers, customProvider])
    expect(patch.agents?.qwicks?.providerId).toBe(customProvider.id)
    expect(patch.agents?.qwicks?.apiKey).toBe('')
    expect(patch.agents?.qwicks?.baseUrl).toBe('')
  })
  ...
  it('builds a single patch when removing the active model provider', () => {
    ...
    const patch = modelProvidersSettingsPatch({
      ...
      qwicks: { providerId: DEFAULT_MODEL_PROVIDER_ID }
    })

    expect(patch.provider?.providers).toEqual(provider.providers)
    expect(patch.agents?.qwicks?.providerId).toBe(DEFAULT_MODEL_PROVIDER_ID)
    expect(patch.agents?.qwicks?.apiKey).toBe('')
    expect(patch.agents?.qwicks?.baseUrl).toBe('')
  })
  ...
  it('builds a single patch when adding a preset model provider', () => {
    ...
    expect(patch.agents?.qwicks).toEqual(expect.objectContaining({
      providerId: 'xiaomi',
      model: xiaomiProvider.models[0]
    }))
  })
  ...
  it('renders MCP, Skill, web, attachment, and memory diagnostics', () => {
    ...
    expect(html).toContain('QWicks diagnostics')
  ...
  it('describes MCP config as an external-tool JSON file instead of model credentials', () => {
    ...
    expect(html).toContain('/tmp/project/.qwicks/mcp.json')
