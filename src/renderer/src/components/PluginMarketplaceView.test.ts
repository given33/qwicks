...
describe('PluginMarketplaceView MCP config helpers', () => {
  it('does not recommend the filesystem MCP server because QWicks has built-in file tools', () => {
  ...
  it('accepts custom JSON as either a single server or a QWicks config fragment', () => {
  ...
  it('detects MCP servers from full QWicks capability config', () => {
  ...
  it('toggles nested QWicks capability MCP servers', () => {
