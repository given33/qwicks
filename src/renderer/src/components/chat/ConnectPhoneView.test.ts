...
describe('ConnectPhoneView', () => {
  ...
  it('renders the dedicated phone connection page before a channel is enabled', () => {
    ...
    expect(html).toContain('Use your phone to connect qwicks')
    ...
    expect(html).not.toContain('QWicks usage')
  })
  ...
  it('builds the default qwicks channel payload after a successful scan', () => {
