...
describe('WorkspaceProjectPicker options', () => {
  it('groups remembered worktree roots under their source project', () => {
    ...
    const worktree38e2 = '/Users/zxy/.qwicks/worktrees/38e2/Kook-VoiceShop-Bot'
    const worktreePython = '/Users/zxy/.qwicks/worktrees/python/Kook-VoiceShop-Bot'
