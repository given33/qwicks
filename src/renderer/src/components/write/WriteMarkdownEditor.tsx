  ...
  useEffect(() => {
    ...
    const inlineCompletionExtension = buildInlineCompletionExtension({
      ...
      requestCompletion: async (context, mode) => {
        if (typeof window.qwicksGui?.requestWriteInlineCompletion !== 'function') return null
      ...
      extensions: [
        ...
        EditorView.domEventHandlers({
          paste(event, view) {
            ...
            if (typeof window.qwicksGui?.saveWorkspaceClipboardImage !== 'function') return false
