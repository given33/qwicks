...
const LEFT_PANEL_WIDTH_KEY = 'qwicks.layout.leftSidebarWidth'
const LEFT_PANEL_COLLAPSED_KEY = 'qwicks.layout.leftSidebarCollapsed'
const RIGHT_PANEL_WIDTH_KEY = 'qwicks.layout.rightInspectorWidth'
const RIGHT_PANEL_MODE_KEY = 'qwicks.layout.rightPanelMode'
const TERMINAL_OPEN_KEY = 'qwicks.layout.terminalOpen'
const TERMINAL_HEIGHT_KEY = 'qwicks.layout.terminalHeight'
