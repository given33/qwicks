...
export type LoadedQWicksDiagnostics = {
...
export async function loadQWicksDiagnostics(
  provider: DiagnosticsProvider,
  options: { workspace?: string } = {}
): Promise<LoadedQWicksDiagnostics> {
  ...
  const loaded: LoadedQWicksDiagnostics = { errors: [] }
