...
function settings(): AppSettingsV1 {
  return {
    ...
    agents: {
      qwicks: {
        ...defaultQWicksRuntimeSettings(),
        binaryPath: '~/bin/qwicks',
        dataDir: '~/.qwicks/data',
        storage: {
          ...defaultQWicksRuntimeSettings().storage,
          sqlitePath: '~/Library/Application Support/QWicks/qwicks.sqlite3'
        }
      }
    },
    workspaceRoot: '~/.qwicks/default_workspace',
    ...
    write: {
      ...defaultWriteSettings(),
      defaultWorkspaceRoot: '~/.qwicks/write_workspace',
      activeWorkspaceRoot: '~/drafts',
      workspaces: ['~/.qwicks/write_workspace', '~/drafts']
    },
    claw: {
      ...defaultClawSettings(),
      skills: {
...
describe('settings home paths', () => {
  it('compacts absolute home paths on macOS and Linux', () => {
    expect(compactHomePathForSettingsDisplay('/Users/mothra/.qwicks/default_workspace', '/Users/mothra', 'darwin'))
      .toBe('~/.qwicks/default_workspace')
    expect(compactHomePathForSettingsDisplay('/home/mothra/.qwicks/default_workspace', '/home/mothra', 'linux'))
      .toBe('~/.qwicks/default_workspace')
  ...
  it('does not compact home paths on Windows', () => {
    expect(compactHomePathForSettingsDisplay('C:\\Users\\mothra\\.qwicks', 'C:\\Users\\mothra', 'win32'))
      .toBe('C:\\Users\\mothra\\.qwicks')
  })

  it('expands tilde input on macOS and Linux only', () => {
    expect(expandHomePathForSettingsUse('~/.qwicks/data', '/Users/mothra', 'darwin'))
      .toBe('/Users/mothra/.qwicks/data')
    expect(expandHomePathForSettingsUse('~/.qwicks/data', '/home/mothra', 'linux'))
      .toBe('/home/mothra/.qwicks/data')
    expect(expandHomePathForSettingsUse('~\\.qwicks\\data', '/Users/mothra', 'win32'))
      .toBe('~\\.qwicks\\data')
  })
  ...
  it('expands nested settings paths before saving', () => {
    ...
    expect(expanded.workspaceRoot).toBe('/Users/mothra/.qwicks/default_workspace')
    expect(expanded.agents.qwicks.binaryPath).toBe('/Users/mothra/bin/qwicks')
    expect(expanded.agents.qwicks.dataDir).toBe('/Users/mothra/.qwicks/data')
    expect(expanded.agents.qwicks.storage.sqlitePath).toBe('/Users/mothra/Library/Application Support/QWicks/qwicks.sqlite3')
    expect(expanded.write.defaultWorkspaceRoot).toBe('/Users/mothra/.qwicks/write_workspace')
