 ...
 * `qwicks-pending-infographic:` scheme, so the document itself carries the
...
export const PENDING_INFOGRAPHIC_PROTOCOL = 'qwicks-pending-infographic:'

const PENDING_SRC_PATTERN = /^qwicks-pending-infographic:\/\/([A-Za-z0-9-]+)$/
...
/** Parse `![alt](qwicks-pending-infographic://id)` image markdown. */
