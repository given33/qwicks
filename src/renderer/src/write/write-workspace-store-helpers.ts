...
export const WRITE_PREVIEW_MODE_KEY = 'qwicks.write.preview-mode'
export const WRITE_ASSISTANT_OPEN_KEY = 'qwicks.write.assistant-open'
export const WRITE_ASSISTANT_MODEL_KEY = 'qwicks.write.assistant-model'
export const WRITE_ASSISTANT_PROVIDER_KEY = 'qwicks.write.assistant-provider'
const DEFAULT_WRITE_ASSISTANT_MODEL = DEFAULT_QWICKS_MODEL
...
export function activeFileStorageKey(workspaceRoot: string): string {
  return `qwicks.write.active-file:${normalizePath(workspaceRoot)}`
}
