...
export type QueuedUserMessage = {
  ...
  /**
   * Optional GUI plan context forwarded to QWicks. The renderer
 ...
 * QWicks `GuiPlanContextSchema` and is forwarded to the runtime
...
export type ChatState = {
  ...
  runtimeStatus: QWicksRuntimeStatusPayload | null
