...
export const DEFAULT_SERVE_MODEL = DEFAULT_TEAMFLOW_AGENT_MODEL

/**
 * Validated CLI options for `teamflow-agent serve`.
 *
...
export const DEFAULT_SERVE_OPTIONS: ServeOptions = {
  ...
  capabilities: DEFAULT_TEAMFLOW_AGENT_CAPABILITIES_CONFIG
}
