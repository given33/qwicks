/**
 * Design-quality detector — Teamflow Agent's first-party frontend output linter.
 *
 ...
 * (Apache-2.0) lint rules — algorithms only, in Teamflow Agent's own naming and copy.
 */
