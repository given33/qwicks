...
import type { TeamflowAgentCapabilitiesConfig } from '../../contracts/capabilities.js'
...
export function buildSpeechGenToolProviders(
  config: TeamflowAgentCapabilitiesConfig['speechGen'] | undefined,
...
export function buildMusicGenToolProviders(
  config: TeamflowAgentCapabilitiesConfig['musicGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
...
export function buildVideoGenToolProviders(
  config: TeamflowAgentCapabilitiesConfig['videoGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
