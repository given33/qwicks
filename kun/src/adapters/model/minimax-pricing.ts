...
const MINIMAX_TEXT_PRICES: Record<string, MiniMaxPrice> = {
  ...
  'minimax-m2.1': { input: 2.1, output: 8.4, cacheRead: 0.21, cacheWrite: 2.625 },
  'minimax-m2.1-highspeed': { input: 4.2, output: 16.8, cacheRead: 0.21, cacheWrite: 2.625 },
  'minimax-m2': { input: 2.1, output: 8.4, cacheRead: 0.21, cacheWrite: 2.625 }
}

const MINIMAX_M3_STANDARD_PRICE: MiniMaxPrice = {
  input: 2.1, output: 8.4, cacheRead: 0.42
}

const MINIMAX_M3_LONG_CONTEXT_PRICE: MiniMaxPrice = {
  input: 4.2, output: 16.8, cacheRead: 0.84
}
