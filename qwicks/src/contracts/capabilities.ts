...
export const QWicksCapabilitiesConfig = z
  .object({
  ...
  .strict()
export type QWicksCapabilitiesConfig = z.infer<typeof QWicksCapabilitiesConfig>

export const DEFAULT_QWICKS_CAPABILITIES_CONFIG: QWicksCapabilitiesConfig = QWicksCapabilitiesConfig.parse({})
...
export function buildRuntimeCapabilityManifest(input: {
  config?: QWicksCapabilitiesConfig
  model: ModelCapabilityMetadata
  mcp?: {
  ...
  const config = QWicksCapabilitiesConfig.parse(input.config ?? {})
