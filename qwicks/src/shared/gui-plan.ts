/**
 * QWicks-side mirror of the shared GUI plan contract from
 * QWicks's `src/shared/gui-plan.ts`.
 *
 * The renderer and the QWicks package live in the same repo but
 * TypeScript's `rootDir` constraint prevents QWicks from
