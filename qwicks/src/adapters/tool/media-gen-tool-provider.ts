...
import type { QWicksCapabilitiesConfig } from '../../contracts/capabilities.js'
...
export function buildSpeechGenToolProviders(
  config: QWicksCapabilitiesConfig['speechGen'] | undefined,
...
export function buildMusicGenToolProviders(
  config: QWicksCapabilitiesConfig['musicGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
...
export function buildVideoGenToolProviders(
  config: QWicksCapabilitiesConfig['videoGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
